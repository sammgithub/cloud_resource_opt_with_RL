...
def get_mobilenet_v3_large(num_classes=10):
    # Load MobileNetV3-Large from torchvision with num_classes set to 10.
...
def train_mobilenet_v3():
    ...
    # Configuration for training MobileNetV3-Large on CIFAR10
    config = {
    ...
    # Transform: Resize CIFAR10 images from 32x32 to 224x224 (as expected by MobileNetV3-Large)
    ...
    for epoch in range(config['epochs']):
        ...
        # Get system metrics and then create separate GPU utilization keys
