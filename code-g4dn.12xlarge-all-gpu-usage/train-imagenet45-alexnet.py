...
def train_imagenet45():
    ...
    # Transform: Resize images to 28x28, convert to tensor, and normalize.
    ...
    # Load the dataset using ImageFolder (expected structure: /home/ec2-user/imagenet45/<class_name>/image files)
