...
def get_vgg16(num_classes=10):
    ...
    # Disable the default adaptive avgpool (which outputs 7x7 feature maps)
    model.avgpool = nn.Identity()
    # Replace the classifier so it accepts 512 features instead of 25088.
...
def train_vgg16():
    ...
    # Configuration updated for CIFAR10 and VGG16
    config = {
        'model_name': 'vgg16',
        'dataset': 'cifar10',
    ...
    for epoch in range(config['epochs']):
        ...
        metrics_df.to_csv('log-cifar10-vgg16.csv', index=False)
