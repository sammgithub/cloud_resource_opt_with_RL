...
def get_inception_v3(num_classes=10):
    # Load Inception v3 with aux_logits disabled so it returns a single output
...
def train_inception_v3():
    ...
    # Configuration updated for CIFAR10 and Inception v3
    config = {
        ...
        'input_dim': '299x299'  # Updated input dimension for Inception v3
    }
    ...
    model = get_inception_v3().to(device)
    ...
    # Update transform to resize CIFAR10 images to 299x299 for Inception v3
    ...
    for epoch in range(config['epochs']):
        ...
        metrics_df.to_csv('log-cifar10-inceptionV3.csv', index=False)
